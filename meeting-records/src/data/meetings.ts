...
export const meetings: MeetingRecord[] = [
    ...
    // 3.4 전체회의 (3월 1주차)
    {
        id: "2026-03-04",
        date: "2026.03.04",
        title: "2026년 3월 1주차 전체 회의",
        subtitle: "웹개발 외주사업 영업 전략 공유",
        attendees: ["유재영", "이동주", "유선화", "김주연", "김주희", "김정연", "류다혜", "김제연"],
        meetingType: 'all',
        isArchived: false,
        agendaItems: [
            { id: 1, content: "임원진 회의 공유사항" },
            { id: 2, content: "웹개발 외주사업 영업 전략" },
            { id: 3, content: "크몽 · 숨고 플랫폼 공략 전략" },
            { id: 4, content: "실행 로드맵 & 타임라인" },
            { id: 5, content: "영업팀 진행상황 공유" }
        ],
        slides: [
            // 슬라이드 1: 타이틀
            {
            ...
            // 슬라이드 2: 오늘의 안건
            {
                type: 'agenda',
                title: "오늘의 안건",
                subtitle: "2026.03.04 (화)",
                sections: [
                    {
                        title: "📋 회의 안건",
                        items: [
                            "<strong>1.</strong> 임원진 회의 공유사항",
                            "<strong>2.</strong> 웹개발 외주사업 영업 전략",
                            "<strong>3.</strong> 크몽 · 숨고 플랫폼 공략 전략",
                            "<strong>4.</strong> 실행 로드맵 & 타임라인",
                            "<strong>5.</strong> 영업팀 진행상황 공유"
                        ],
                        status: 'info'
                    }
                ]
            },
            // 슬라이드 3: 임원진 회의 공유사항 — 악센트/와우 미래 전략
            {
                type: 'agenda',
                title: "임원진 회의 공유사항",
                subtitle: "3/2 회의 — 악센트 아이디/와우 미래 전략 (논의중)",
                sections: [
                    {
                        title: "🔄 1. 재방문률 제고",
                        items: [
                            "재방문 시 10% 할인 쿠폰 발송",
                            "리타겟팅 메시지 발송",
                            "온라인 사이트 연동 스탬프 카드 (3회 방문시 무료 체험권 1매 제공)",
                            "<strong>네이버 공지 및 쿠폰 설계 필수</strong>",
                            "<strong>네이버 톡톡 마케팅 메시지 발송 필수</strong>",
                            "<strong>웹사이트 수정 필수</strong>"
                        ],
                        status: 'info'
                    },
                    {
                        title: "🛍️ 2. 추가 상품 구성",
                        items: [
                            "소액 굿즈 (5,000원 선) 출시 — 충동 구매 유도, 객단가 상승",
                            "팟 키링 등 유료 판매로 DP, 리뷰 이벤트 참여시 무료 증정 (리뷰 참여율 ↑)",
                            "<strong>오프라인 판매 한정</strong>"
                        ],
                        status: 'info'
                    },
                    {
                        title: "🎨 3. 이벤트 상품 (와우) 재설계",
                        items: [
                            "향수/사쉐 투트랙 상품군에서 점진적 탈피",
                            "와우에서 대형 주최자 중심 피규어 디퓨저 출시 (이벤트별 고정 1개 디자인) — 38,000원",
                            "3D 프린터를 와우에 배치 → 악센트 와우를 피규어 공방으로 리브랜딩?"
                        ],
                        status: 'warning'
                    },
                    {
                        title: "👥 4. 그룹 특화 상품 강화",
                        items: [
                            "2인/4인 동반 방문 시 할인 쿠폰 발행 (예: 96,000원 이상 구매 시 네이버예약 10% 할인)",
                            "4인 방문객 전용 특별 증정 상품 디벨롭 (리뷰 키링, 키캡키링 등)",
                            "<strong>네이버 공지 및 쿠폰 설계 필수</strong>"
                        ],
                        status: 'info'
                    },
                    {
                        title: "🕐 5. 운영시간 재설계",
                        items: [
                            "평일: 15시~21시 (학기 중 이른 방문객 저조, 하교/퇴근 이후 유도)",
                            "주말: 11시~21시 (주말 방문객 몰림 대응)",
                            "이벤트 운영시간: 현행 유지",
                            "<strong>네이버 공지 필수</strong>"
                        ],
                        status: 'warning'
                    }
                ]
            ...
            // 슬라이드 4: 크몽 숨고 전략
            {
                type: 'timeline',
                title: "크몽 숨고 전략",
                subtitle: "기반 구축 → 리뷰 확보 → 광고 테스트 → 스케일업 → 커뮤니티",
                timeline: [
                    { date: "Week 1", title: "기반 구축", description: "크몽 전문가 인증 · 숨고 고수 등록 · 포트폴리오 5개+ · 서비스 등록 · 키워드 최적화", status: "completed" },
                    { date: "Week 2-3", title: "리뷰 확보", description: "지인 통한 첫 3건 거래 · 컨설팅 1만원 리뷰 수집 · 숨고 견적 발송 · 30분 내 응답 습관화", status: "current" },
                    { date: "Week 4", title: "광고 테스트", description: "크몽 클릭 광고 소액 테스트 · 키워드별 전환율 측정 · 숨고 예산 효율 분석 · 견적서 A/B 테스트", status: "upcoming" },
                    { date: "Month 2-3", title: "스케일업", description: "광고 예산 증액 · 프리미엄 패키지 판매 · 리뷰 20건+ · 월 3건 이상 개발 계약 · 프로세스 자동화", status: "upcoming" }
                ],
                sections: [
                    {
                        title: "🎯 단계별 목표",
            ...
            // 나라장터 목표 공유
            {
                type: 'timeline',
                title: "나라장터 입찰 — 목표 공유",
                subtitle: "공공입찰 준비 로드맵",
                timeline: [
                    { date: "3월", title: "서류 완비 & 마스터", description: "나라장터 입찰에 필요한 모든 서류 준비 완료 · 나라장터에 대한 모든 것을 마스터한다", status: "current" },
                    { date: "4월", title: "첫 입찰 수주", description: "4월에 첫 입찰을 따내는 것이 목표", status: "upcoming" }
                ],
                sections: [
                    {
                        title: "👤 담당자",
                        items: [
                            "<strong>유재영, 김주희</strong> — 나라장터 입찰 서류 준비 및 프로세스 학습"
                        ],
                        status: 'info'
                    }
                ]
            ...
            {
                type: 'agenda',
                title: "국제작가축제 — 공간계획 공유",
                subtitle: "3/3 선 미팅 완료 · 예상 2,000만원 · 견지동 문화시설",
                sections: [
                    {
                        title: "🏢 1층 — 로비 · 체험존",
                        items: [
                            "<strong>AI 포토부스</strong> — 1층 메인 배치",
                            "<strong>취향 AI (3대)</strong> — 취향 스와이프 체험",
                            "작가와 함께쓰기 챌린지",
                            "도서 매대 · 도서 결제",
                            "포토존 / 사인회",
                            "티켓부스 · 라방 부스 · 사무실"
                    ...
                    },
                    {
                        ...
                        items: [
                            "대담 (13개 세션) + 스페셜 (1개 세션)",
                            "계단식 객석 · 플로어 객석 · 카메라 · 미디어콘솔",
                            "<strong>'소설의 향기' 존 — 다른 아이디어 필요!</strong>",
                            "행잉 오브제 설치 (3가지 안 검토 중)",
                            "대기실 / 휴게실"
                        ],
                        status: 'warning'
                    },
                    {
                        title: "📺 작가 인스타 라방 부스 · 인터뷰 존",
                        items: [
                            "작가 인스타 라방 부스 — 실시간 방송 전용 공간",
                            "인터뷰 존 — 별도 촬영/인터뷰 공간"
                        ],
                        status: 'success'
                    }
            ...
            // 슬라이드 12: 국제작가축제 — AI 콘텐츠 아이디어
            {
                type: 'strategy',
                title: "국제작가축제 — AI 콘텐츠 아이디어",
                subtitle: "'소설의 향기' 존 + AI 체험 콘텐츠 — 아이디어 필요!",
                goals: [
                    {
                        title: "1층 AI 체험존",
                        icon: "📸",
                        ...
                        highlight: true,
                        items: [
                            "AI 포토부스 — 작가/소설 콘셉트 AI 프로필 촬영",
                            "취향 AI (3대) — 취향 스와이프 → AI 맞춤 도서/콘텐츠 추천",
                            "AI 캐리커쳐 — 작가 캐릭터화 + 대표 문장 삽입 엽서"
                        ]
                    },
                    {
                        title: "소설의 향기 존 (3층)",
                        ...
                        color: "#EC4899",
                        items: [
                            "AI 조향 — 소설 분위기를 향수로 조합 (악센트 핵심 역량)",
                            "소설 한 구절 입력 → AI가 향 레시피 추천 → 현장 제조",
                            "⚠️ 다른 아이디어도 필요 — 브레인스토밍 필요"
                        ]
                    },
                    {
                        title: "AI × 문학 인터랙티브",
                        ...
                        color: "#8B5CF6",
                        items: [
                            "AI 시(詩) 생성 — 키워드 입력 → AI 시 한 편 → 엽서 출력",
                            "AI 북커버 디자인 — 내가 쓴 짧은 글의 AI 표지 제작",
                            "AI 스토리텔러 — AI와 대화하며 즉석 단편소설 공동 창작"
                        ]
                    },
                    {
                        title: "💬 논의 포인트",
                        ...
                        color: "#F59E0B",
                        items: [
                            "'소설의 향기' 존 — AI 조향 외 다른 콘텐츠 아이디어?",
                            "3가지 객석 배치안 중 최종 선택 필요",
                            "예산 배분 및 운영 인력 계획 수립"
                        ]
                    }
                ]
    ...
    // 2.11 전체회의 (2월 2주차)
    {
        id: "2026-02-11",
        date: "2026.02.11",
        title: "2026년 2월 2주차 전체 회의",
        subtitle: "특이사항 공유 및 안건 논의",
        attendees: ["유재영", "이동주", "유선화", "김주연", "김주희", "김정연", "류다혜", "김제연"],
        meetingType: 'all',
        isArchived: false,
        agendaItems: [
        ...
        slides: [
            ...
            // 슬라이드 2: 오늘의 안건
            {
                type: 'agenda',
                title: "오늘의 안건",
                subtitle: "2026.02.11 (수)",
                sections: [
                    {
                        title: "📋 회의 안건",
                        items: [
                            "<strong>1.</strong> 전체회의 순서 다시 공유",
                            "<strong>2.</strong> 노션에서 우리의 시스템(체계) 공유",
                            "<strong>3.</strong> 영업팀 진행상황 공유",
                            "<strong>4.</strong> 영업팀 KPI & 김주희 책임과 권한"
                        ],
                        status: 'info'
                    }
                ]
            ...
            // 슬라이드 4: 노션 시스템 공유
            {
                ...
                title: "우리의 시스템(체계) 공유",
                subtitle: "노션으로 함께 확인",
                linkUrl: "https://www.notion.so/neander/2026-2fd9d0690a1c808faa6dfd5320b1a12c",
                sections: []
            },
            // 슬라이드 5: 영업팀 앞으로의 방향 - 인바운드 영업
            {
                type: 'strategy',
                title: "영업팀 진행상황 그리고 앞으로의 방향",
                subtitle: "아웃바운드 → 인바운드 전환",
                linkUrl: "https://meeting-2w.vercel.app",
                sections: [
                    {
                        title: "⚠️ 현재 한계",
                        items: [
                            "더욱 많은 미팅만으로는 분명히 한계가 있을 것"
                        ],
                        status: 'warning'
                    },
                    {
                        title: "🔄 인바운드 영업 추가",
                        items: [
                            "우리가 연락하는 게 아니라 연락이 오게",
                            "저절로 영업이 되게끔 다양한 매체, 인터넷에 우리 회사의 정보를 남기는 영업 방식",
                            "현재 영업팀에서 준비 중",
                            "마케팅팀과의 협업 제안 예정"
                        ],
                        highlight: true
            ...
            // 슬라이드 8: 영업팀 KPI (분기별)
            {
                type: 'comparison',
                title: "영업팀 KPI (분기별)",
                subtitle: "2026년 영업팀 분기별 핵심 성과 지표",
                comparison: {
                    headers: ["분기", "웹개발 외주", "AI 컨텐츠 B2B (연 1.5억 · 6건+)", "온라인"],
                    rows: [
                        ["Q1", "월 매출 300만 목표", "준비 및 영업 (2,000만)", "온라인 마케팅 시작"],
                        ["Q2", "월 매출 500만 목표", "확장 (4,000만)", "온라인 매출 본격화"],
                        ["Q3", "월 매출 700만 목표", "운영 (5,000만)", "온라인 매출 성장"],
                        ["Q4", "월 매출 1,000만 목표", "정산 및 운영 (4,000만)", "온라인 채널 확대"]
                    ]
                },
                sections: [
                    {
            ...
            // 슬라이드 9: 김주희 책임과 권한 + 업무 담당
            {
                type: 'business',
                title: "김주희 책임과 권한",
                subtitle: "영업 및 매장관리에 대한 책임과 권한 부여 · 관련 이슈는 김주희님께 공유",
                businessAreas: [
                    {
                        name: "영업팀",
                        icon: "💼",
    ...
    // 2.4 전체회의
    {
        id: "2026-02-04",
        date: "2026.02.04",
        title: "2026년 2월 1주차 전체 회의",
        subtitle: "시스템 공유 & 영업팀 진행상황",
        attendees: ["유재영", "이동주", "유선화", "김주연", "김주희", "김정연", "류다혜", "김제연"],
        meetingType: 'all',
        isArchived: false,
        agendaItems: [
            { id: 1, content: "전체회의 순서 다시 공유" },
            { id: 2, content: "노션에서 우리의 시스템(체계) 공유" },
            { id: 3, content: "영업팀 진행상황 공유" },
            { id: 4, content: "영업팀 KPI & 김주희 책임과 권한" }
        ],
        slides: [
            // 슬라이드 1: 타이틀
            {
            ...
            // 슬라이드 5: 영업팀 진행상황 개요
            {
                type: 'kpi',
                title: "영업팀 진행상황",
                subtitle: "이번주 주요 활동 요약",
                kpis: [
                    { label: "미팅 진행", value: "5건+", target: "앞으로 더 적극적으로!", status: "success" },
                    { label: "크몽 등록", value: "진행중", target: "네안데르, 일해라컴퍼니", status: "warning" },
                    { label: "코리아그랜드세일", value: "완벽 진행", target: "100%", status: "success" },
                    { label: "뿌디 제작", value: "~15개", target: "이번주 제작량", status: "success" }
                ],
                sections: [
                    {
                        title: "🚀 앞으로의 방향",
                        items: [
                            "더욱 많은 미팅을 적극적으로 잡아서 기회를 포착할 예정"
                        ],
                        status: 'success',
                        highlight: true
                    },
                    {
                        title: "🔗 악센트 운영 매커니즘",
                        items: [
                            "https://website-three-chi-54.vercel.app"
                        ],
                        status: 'info'
                    }
                ]
            },
            // 슬라이드 6: 크몽 진행현황 - 일해라컴퍼니
            {
                type: 'summary',
                title: "크몽 진행현황",
                subtitle: "일해라컴퍼니 & 네안데르",
                sections: [
                    {
                        title: "🏢 일해라컴퍼니",
                        items: [
            ...
            // 슬라이드 7: 리뷰 쌓기 전략 안내
            {
                type: 'agenda',
                title: "리뷰 쌓기 전략",
                subtitle: "다음주 회의에서 공유 예정",
                sections: [
                    {
                        title: "🎯 예고",
                        items: [
                            "다음주 회의까지 리뷰 쌓기 전략 전달드리겠습니다!"
                        ],
                        status: 'info',
                        highlight: true
                    }
            ...
            // 슬라이드 9: 영업팀 KPI
            {
                ...
                subtitle: "2026년 목표",
                kpis: [
                    { label: "3개월 목표", value: "300만원", target: "월 매출 (4월까지)", status: "success" },
                    { label: "연간 목표", value: "1,000만원", target: "월 매출 (12월까지)", status: "success" }
                ],
                sections: [
                    {
                        title: "💡 KPI 달성 전략",
            ...
            // 슬라이드 12: 마무리
            {
                type: 'agenda',
                title: "공유 사항",
                subtitle: "김주희님에게 전달해주세요",
                sections: [
                    {
                        title: "📢 안내",
                        items: [
                            "김주희님에게 영업 및 매장관리에 대한 <strong>책임과 권한</strong>이 부여됩니다",
                            "관련 이슈는 김주희님께 공유해주세요!"
                        ],
                        status: 'success',
                        highlight: true
    ...
    // 2.1 임원진 회의
    {
        id: "2026-02-01",
        date: "2026.02.01",
        title: "2026년 2월 1주차 임원진 회의",
        subtitle: "안건 처리 및 회계 공유",
        attendees: ["유재영", "이동주", "유선화", "김주연"],
        meetingType: 'executive',
        isArchived: false,
        agendaItems: [
            { id: 1, content: "임원진 회의 운영 방식 변경 안내" },
            { id: 2, content: "리뷰이벤트 상품 고민" },
            { id: 3, content: "시그니처 상품 고민" },
            { id: 4, content: "KPI (분기별 1년치)" },
            { id: 5, content: "직원 정책 정립 (권한과 책임)" }
        ],
        slides: [
            // 슬라이드 1: 타이틀
            {
            ...
            // 슬라이드 2: 임원진 회의 운영 방식 변경
            {
                type: 'agenda',
                title: "임원진 회의 운영 방식 변경",
                subtitle: "효율적인 회의 구조 개편",
                sections: [
                    {
                        title: "📢 변경 사항",
                        items: [
                            "진행 상황 공유 및 특이사항 중 전체회의에서 해도 되는 이야기는 전체회의에서 공유 부탁드립니다",
                            "앞으로 임원진 회의에서는 회계장부 공유 및 임원진 안건 처리만 진행합니다"
                        ],
                        status: 'info'
                    },
                    {
            ...
            {
                type: 'agenda',
                title: "시그니처 상품에 대한 고민",
                subtitle: "케이스 & 향 구성",
                sections: [
                    {
                        title: "📦 케이스",
                        items: [
                            "시그니처 라인 전용 케이스 디자인 방향",
                            "단가 및 제작 방식 검토"
                        ]
                    },
                    {
            ...
            // 슬라이드 5: KPI (분기별 1년치)
            {
                ...
                sections: [
                    ...
                    },
                    {
                        title: "📊 KPI 기준",
                        items: [
                            "팀별 구체적 수치 목표 설정 (매출 / 마케팅 / 개발 / 운영)",
                            "예산 초과분에 대한 승인 프로세스 필요",
                            "건당 금액 기준 설정 (의미 있는 성과 중심)",
                            "분기별 방향성 점검 및 KPI 조정"
                        ],
                        status: 'info'
                    }
            ...
            // 슬라이드 6-1: 영업 전략
            {
                type: 'strategy',
                title: "영업 전략",
                subtitle: "네트워킹 · 채널 · 실행 방향",
                goals: [
                    {
                        title: "네트워킹 (사람을 많이 만난다)",
                        icon: "🤝",
                        color: "#8B5CF6",
                        highlight: true,
                        items: [
                    ...
                    {
                        title: "보조 채널: 크몽/숨고 (리뷰 쌓기)",
                        icon: "🛒",
                        color: "#3B82F6",
                        items: [
                            "AI 프로필 사진 · AI 이미지 생성 등록",
                            "저가 진입 → 리뷰 확보 → 고가 전환",
                            "힉스필드로 상세페이지 빠르게 제작"
                        ]
                    },
                    {
                        ...
                        color: "#10B981",
                        items: [
                            "컨설팅 1만 → MVP 개발 100만+ 전환",
                            "AI 개발로 원가 50% 절감 = 핵심 경쟁력",
                            "지원사업 침투 영업 유지"
                        ]
                    }
                ]
            ...
            // 슬라이드 7: 직원 정책 정립
            {
                type: 'organization',
                title: "직원 정책 정립",
                subtitle: "권한과 책임 체계 구축",
                sections: [
                    {
                        title: "🔑 권한 체계",
                        items: [
                            "직급/역할별 의사결정 권한 범위 정의",
                            "승인 프로세스 및 결재 라인 정립",
                            "업무 자율성 범위 설정"
                        ]
                    },
