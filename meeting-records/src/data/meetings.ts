...
export const meetings: MeetingRecord[] = [
    // 2.9 임원진 회의
    {
        id: "2026-02-09",
        date: "2026.02.09",
        title: "2026년 2월 2주차 임원진 회의",
        subtitle: "특이사항 공유 및 안건 논의",
        attendees: ["유재영", "이동주", "유선화", "김주연"],
        meetingType: 'executive',
        isArchived: false,
        agendaItems: [
            { id: 1, content: "영업팀 주간 미팅 현황" },
            { id: 2, content: "미팅 방향성 및 타겟 전략" },
            { id: 3, content: "차주 미팅 예정 건" }
        ],
        slides: [
            // 슬라이드 1: 타이틀
            {
            ...
            // 슬라이드 3: 주간 미팅 현황
            {
                ...
                kpis: [
                    ...
                    },
                    {
                        ...
                        value: "네트워킹",
                        target: "소개 기반 가벼운 미팅",
                        status: 'info' as 'success' | 'warning' | 'danger'
                    }
                ],
                sections: [
                    {
                        title: "💡 미팅 방향",
                        items: [
                            "영업 미팅 보다는 다양한 소개를 받기 위한 가벼운 미팅 자리"
                        ],
                        status: 'info'
                    },
                    {
            ...
            // 슬라이드 5: 차주 미팅 예정
            {
                ...
                timeline: [
                    ...
                    },
                    {
                        date: "미팅 4",
                        title: "최대표님",
                        description: "올리브영 등 다양한 네트워크 확보",
                        status: 'upcoming'
                    }
                ]
            },
