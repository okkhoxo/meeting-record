...
export const meetings: MeetingRecord[] = [
    {
        ...
        slides: [
            ...
            {
                type: 'vision',
                title: "네안데르 2023년 회고 (https://meeting-records-eubyiysua-okkhoxos-projects.vercel.app/네안데르_2023_자료.pdf)",
                sections: [
                    {
                        title: "",
                        items: [
            ...
            {
                type: 'vision',
                title: "네안데르 2024년 회고 (https://meeting-records-eubyiysua-okkhoxos-projects.vercel.app/네안데르_2024_자료.pdf)",
                sections: [
                    {
                        title: "",
                        items: [
            ...
            {
                type: 'organization',
                title: "유선화 (https://meeting-records-eubyiysua-okkhoxos-projects.vercel.app/유선화_2026_목표.pdf)",
                sections: [
                    {
                        title: "2026 개인 목표",
                        items: [
